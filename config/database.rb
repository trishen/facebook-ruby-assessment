...
# Heroku controls what database we connect to by setting the
# DATABASE_URL environment variable. We need to respect that if we want our
# Sinatra apps to run on Heroku without modification
